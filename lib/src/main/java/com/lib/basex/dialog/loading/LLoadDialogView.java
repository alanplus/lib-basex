...
public class LLoadDialogView extends View {
    ...
    public LLoadDialogView(Context context) {
        super(context);
        init();
    }

    public LLoadDialogView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LLoadDialogView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
