...
public class Logger {
    ...
    public static void append(String text) {
        if (!LApplication.app.isDebug() || TextUtils.isEmpty(text))
            return;
        String path = Environment.getExternalStorageDirectory().getPath() + "/a.txt";
        File file = new File(path);
    ...
    public static void writeFile(String text, String path, String name) {
        ...
        File file = new File(LFileUtils.join(path, name));
        if (file.exists()) {
            file.delete();
        }
        try {
    ...
    public static String tag() {
        return LApplication.app.getLogTag();
    }
    ...
    public static void d(int s) {
        println(Log.DEBUG, tag(), String.valueOf(s));
    }
    ...
    private static void println(int priority, String tag, String msg) {
        if (!LApplication.app.isDebug() || TextUtils.isEmpty(msg) || TextUtils.isEmpty(msg))
            return;
