package com.lib.basex.utils.statusbar;
 ...
 */
public class LStatusBar implements IStatusBarTools {


    private static LStatusBar statusBarTools;
    ...
    public static LStatusBar getStatusBar() {
        if (null == statusBarTools) {
            statusBarTools = new LStatusBar();
        }
