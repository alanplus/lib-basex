 ...
 * 基本功能：广告滚动条，支持自动轮播
 */
public class LBannerLayout extends RelativeLayout {
    ...
    public LBannerLayout(Context context) {
        super(context);
        init(null, 0);
    }

    public LBannerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public LBannerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr);
    }

    private void init(AttributeSet attrs, int defStyle) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.LBannerLayoutStyle, defStyle, 0);
        selectedIndicatorColor = array.getColor(R.styleable.LBannerLayoutStyle_l_selectedIndicatorColor, selectedIndicatorColor);
        unSelectedIndicatorColor = array.getColor(R.styleable.LBannerLayoutStyle_l_unSelectedIndicatorColor, unSelectedIndicatorColor);

        int shape = array.getInt(R.styleable.LBannerLayoutStyle_l_indicatorShape, Shape.oval.ordinal());
        ...
        indicatorSpace = (int) array.getDimension(R.styleable.LBannerLayoutStyle_l_indicatorSpace, indicatorSpace);
        indicatorMargin = (int) array.getDimension(R.styleable.LBannerLayoutStyle_l_indicatorMargin, indicatorMargin);
        autoPlayDuration = array.getInt(R.styleable.LBannerLayoutStyle_l_autoPlayDuration, autoPlayDuration);
        scrollDuration = array.getInt(R.styleable.LBannerLayoutStyle_l_scrollDuration, scrollDuration);
        isAutoPlay = array.getBoolean(R.styleable.LBannerLayoutStyle_l_isAutoPlay, isAutoPlay);
        defaultImage = array.getResourceId(R.styleable.LBannerLayoutStyle_l_defaultImage, defaultImage);
        array.recycle();
    ...
    private ImageView getImageView(Integer res, final int position) {
        ...
        new LImageBuilder().setRes(res).build(imageView);
        return imageView;
    }
