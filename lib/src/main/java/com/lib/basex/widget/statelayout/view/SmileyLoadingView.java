...
public class SmileyLoadingView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        // get attrs
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.LSmileyLoadingView);
        mStrokeColor = ta.getColor(R.styleable.LSmileyLoadingView_l_strokeColor, DEFAULT_PAINT_COLOR);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.LSmileyLoadingView_l_strokeWidth, dp2px(DEFAULT_PAINT_WIDTH));
        mAnimDuration = ta.getInt(R.styleable.LSmileyLoadingView_l_duration, DEFAULT_ANIM_DURATION);
        mAnimRepeatCount = ta.getInt(R.styleable.LSmileyLoadingView_l_animRepeatCount, ValueAnimator.INFINITE);
        ta.recycle();
